...
If DataCombo1(0).Text = "" Or DataCombo1(1).Text = "" Or DataCombo1(2).Text = "" Or DataCombo1(5).Text = "" Then
MsgBox ("输入内容不完整!")
Exit Sub
End If
...
If DataCombo1(0) = "" Then
Adodc1.RecordSource = "select * from cbfy order by 成本期间,成本序号"
Adodc1.Refresh
Else
Adodc1.RecordSource = "select * from cbfy where 成本期间='" & DataCombo1(0) & "' order by 成本序号"
Adodc1.Refresh
DataCombo1(5).Text = Adodc1.Recordset.RecordCount + 1
End If
...
Adodc1.Refresh
       Case 2, 3
DataCombo1(4) = Format(Val(DataCombo1(2)) * Val(DataCombo1(3)), "#0.00")
End Select
End Sub
...
Adodc3.RecordSource = "SELECT distinct 成本名称 FROM CBFY order by 成本名称"
Adodc3.Refresh

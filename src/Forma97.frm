...
Call MXOutadodcToExcel(VSFlexGrid1, "工序预警")
End Sub
...
sql1 = "delete from yj_gxyj where len(工序)< 6 "
...
Adodc1.RecordSource = "SELECT * from yj_gxyj where 客户 like '%'+'" & Text1(0) & "'+'%'  order by 客户,序号"
Adodc1.Refresh
End Select
End Sub

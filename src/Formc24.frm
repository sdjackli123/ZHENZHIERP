...
sql1 = sql1 + "合同负责 like '%'+'" & DataCombo5 & "'+'%' and "
End If
...
Adodc2.RecordSource = "SELECT * FROM v_jgmx_kc_klfx_ok where (" + sql1 + ")   ORDER BY 日期,锅号"
Adodc2.Refresh
Adodc3.RecordSource = "SELECT round(sum(isnull(库存匹数,0)),2) as 库存匹数,round(sum(isnull(库存数量,0)),2) as 库存数量,round(sum(isnull(库存金额,0)),2) as 库存金额,round(sum(isnull(利息,0)),2) as 利息合计 FROM v_jgmx_kc_klfx_ok where (" + sql1 + ") "
Adodc3.Refresh
...
Set g_Cmd = New Command
    ...
    g_Cmd.CommandText = "jgmxzl('" & rq2 & "','" & rq1 & "','" & rq4 & "','" & RQ3 & "','" & rq6 & "','" & rq5 & "','" & rq8 & "','" & rq7 & "','" & rq9 & "','" & yhm & "')"      ' 表示调用哪个存储过程
    g_Cmd.Execute           ' 执行存储过程
g_Cmd.Cancel
Command2.Enabled = True
MsgBox ("汇总成功！")
Adodc5.RecordSource = "SELECT * FROM jgmx_zlcx where 用户='" & yhm & "'"
Adodc5.Refresh

End Sub

Private Sub Command3_Click()
'Call OutadodcToExcel(VSFlexGrid3, dybl, "光坯库龄账龄分析表")
End Sub
...
Adodc2.RecordSource = "select * from v_jgmx_kc_klfx_ok where 日期=cast('" & Date & "' as datetime) order by 客户,锅号"
Adodc2.Refresh
Adodc3.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc4.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc4.RecordSource = "select distinct 负责 from ywf"
Adodc4.Refresh
Adodc5.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc5.RecordSource = "select * from jgmx_zlcx where 用户='" & yhmc & "'"
Adodc5.Refresh

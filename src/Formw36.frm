...
Data2.RecordSource = "select * from PMJHFP where  结转日期 between cdate('" & Text1 & "') and cdate('" & rqq & "') ORDER BY 结转日期 DESC"
Data2.Refresh
End Sub

Private Sub Command6_Click()
Call MXOutDataToExcel(MSFlexGrid1, "发票期初打印")
End Sub
...
Data1.RecordSource = "select 简称 from GYS  GROUP BY 简称"
Data1.Refresh
rqq = CDate(Text2.Text)

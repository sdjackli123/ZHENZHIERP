...
If Option1.Value = True Then
    Data3.RecordSource = "select distinct 客户 from jhjd where 接单日 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='进行'"
    Data3.Refresh
    m = 1
    If Not Data3.Recordset.EOF Then  'make sure there are records in the table
        ...
        Data4.RecordSource = "select distinct 单号 from jhjd where 客户='" & Data3.Recordset.Fields(0) & "' and  接单日 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='进行'"
        Data4.Refresh
        ...
        Data5.RecordSource = "select distinct 款号 from jhjd where 单号='" & Data4.Recordset.Fields(0) & "' and 进度='进行'"
        Data5.Refresh
...
If Option3.Value = True Then
    Data3.RecordSource = "select distinct 客户 from jhjd where 接单日 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "')"
    Data3.Refresh
    m = 1
    If Not Data3.Recordset.EOF Then  'make sure there are records in the table
        Data3.Recordset.MoveFirst
        ...
        mNode.Text = Data3.Recordset.Fields(0)
        intIndex = mNode.Index
        Data4.RecordSource = "select distinct 单号 from jhjd where 客户='" & Data3.Recordset.Fields(0) & "' and  接单日 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "')"
        Data4.Refresh
        ...
        mNode.Text = Trim(Data4.Recordset.Fields(0))
        xntIndex = mNode.Index
        Data5.RecordSource = "select distinct 款号 from jhjd where 单号='" & Data4.Recordset.Fields(0) & "'"
        Data5.Refresh
...
If Option2.Value = True Then
    Data3.RecordSource = "select distinct 客户 from jhjd where 接单日 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='结束'"
    Data3.Refresh
    m = 1
    If Not Data3.Recordset.EOF Then  'make sure there are records in the table
        Data3.Recordset.MoveFirst
        ...
        mNode.Text = Data3.Recordset.Fields(0)
        intIndex = mNode.Index
        Data4.RecordSource = "select distinct 单号 from jhjd where 客户='" & Data3.Recordset.Fields(0) & "' and  接单日 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='结束'"
        Data4.Refresh
        ...
        mNode.Text = Trim(Data4.Recordset.Fields(0))
        xntIndex = mNode.Index
        Data5.RecordSource = "select distinct 款号 from jhjd where 单号='" & Data4.Recordset.Fields(0) & "' and 进度='结束'"
        Data5.Refresh
...
Data2.RecordSource = "select * FROM jhjd WHERE instr(客户,'" & TreeView1.Nodes(Node.Index).FullPath & "')>0  and 日期 bwteen cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') order by 单号,款号"
Data2.Refresh
Else
...
l1 = Mid(TreeView1.Nodes(Node.Index).FullPath, InStr(TreeView1.Nodes(Node.Index).FullPath, "\") + 1)
End If
Data2.RecordSource = "select * FROM jhjd WHERE instr(单号,'" & l1 & "')>0 order by 单号,款号"
Data2.Refresh
End If

...
Set rd = ba.OpenRecordset("RSZL", dbOpenDynaset)
Data1.DatabaseName = "d:\数据库\\htgl\2011\SCZYJHD.mdb"
Data1.RecordSource = "select * from RSZL order by val(ip)"
Data1.Refresh
If Data1.Recordset.EOF Then
MSFlexGrid1.TextMatrix(0, 0) = "记录号"
Else
...
Data2.DatabaseName = "d:\数据库\\htgl\2011\SCZYJHD.mdb"
Data2.RecordSource = "select 客户名称 from RSZL group by 客户名称"
Data2.Refresh
Text1(6).Text = Data1.Recordset.RecordCount + 1
DBCombo1.TabIndex = 0

...
Adodc4.RecordSource = "select 锅号,品名,颜色,色号,数量,车台,信息,编号,汽值 from pld where SUBSTRING(锅号, 1, LEN(锅号) - PATINDEX('%-%', 锅号))='" & Text1 & "' order by 编号"
Adodc4.Refresh
End Sub

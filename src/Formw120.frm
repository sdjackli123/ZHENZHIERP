...
Begin VB.Form Formw120 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "Formw120.frx":0015
      Left            =   5760
      List            =   "Formw120.frx":0022
      TabIndex        =   0
      Text            =   "Combo1"
      Top             =   1320
      Width           =   975
...
Adodc1.RecordSource = "select * from NCSZ order by 序号 DESC"
Adodc1.Refresh
For i = 0 To 4
Text1(i).Text = ""
Next

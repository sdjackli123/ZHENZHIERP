...
Data1.Refresh
Data11.RecordSource = "select * from zxbz where 编号='" & Text2.Text & "'"
Data11.Refresh
End Sub
...
Data1.DatabaseName = "\\192.168.1.254\lbj$\" + ljb + "\ZCW.MDB"
Data1.RecordSource = "select 客户,单号,编号,款号,规格,单位,价格,颜色1,数量1,颜色2,数量2,颜色3,数量3,颜色4,数量4,颜色5,数量5,小计,提货,金额,折扣 from zxd where 编号='" & Text2.Text & "' order by 编号,序号"
Data1.Refresh
Data11.RecordSource = "select * from zxbz where 编号='" & Text2.Text & "'"
Data11.Refresh
End Sub
...
Data1.DatabaseName = "\\192.168.1.254\lbj$\" + ljb + "\ZCW.MDB"
Data1.RecordSource = "select 客户,单号,编号,款号,规格,单位,价格,颜色1,数量1,颜色2,数量2,颜色3,数量3,颜色4,数量4,颜色5,数量5,小计,提货,金额,折扣 from zxd where 单号='" & Text1.Text & "' order by 编号,序号"
Data1.Refresh
Data11.RecordSource = "select * from zxbz where 单号='" & Text1.Text & "' order by 编号"
Data11.Refresh
End Sub
...
Data9.Database.Execute "insert into zxbz(编号,费用,备注,单号,客户,序号,类别) VALUES('" & Text2.Text & "','" & Text3.Text & "','" & Text4.Text & "','" & Text1.Text & "','" & h2 & "',1,'应收类')"
MsgBox ("已确定！")
Data11.RecordSource = "select * from zxbz where 编号='" & Text2.Text & "'"
Data11.Refresh
End Sub
...
Data1.DatabaseName = "\\192.168.1.254\lbj$\" + ljb + "\ZCW.MDB"
Data1.RecordSource = "select 客户,单号,编号,款号,规格,单位,价格,颜色1,数量1,颜色2,数量2,颜色3,数量3,颜色4,数量4,颜色5,数量5,小计,提货,金额,折扣 from zxd where 编号='" & Text2.Text & "'"
Data1.Refresh
...
If Option4.Value = True Then
    Data6.RecordSource = "select distinct 客户 from sczy_xdd where 日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='进行'"
    Data6.Refresh
    m = 1
    If Not Data6.Recordset.EOF Then  'make sure there are records in the table
        ...
        Data4.RecordSource = "select distinct 单号 from sczy_xdd where 客户='" & Data6.Recordset.Fields(0) & "' and  日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='进行'"
        Data4.Refresh
        ...
        Data5.RecordSource = "select distinct 款号 from sczy_xdd where 单号='" & Data4.Recordset.Fields(0) & "' and 进度='进行'"
        Data5.Refresh
...
If Option5.Value = True Then
    Data6.RecordSource = "select distinct 客户 from sczy_xdd where 日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='结束'"
    Data6.Refresh
    m = 1
    If Not Data6.Recordset.EOF Then  'make sure there are records in the table
        Data6.Recordset.MoveFirst
        ...
        mNode.Text = Data6.Recordset.Fields(0)
        intIndex = mNode.Index
        Data4.RecordSource = "select distinct 单号 from sczy_xdd where 客户='" & Data6.Recordset.Fields(0) & "' and  日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='结束'"
        Data4.Refresh
        ...
        mNode.Text = Trim(Data4.Recordset.Fields(0))
        xntIndex = mNode.Index
        Data5.RecordSource = "select distinct 款号 from sczy_xdd where 单号='" & Data4.Recordset.Fields(0) & "' and 进度='结束'"
        Data5.Refresh
...
Data7.Database.Execute "INSERT INTO zxdf(客户,单号,款号,规格,颜色,数量) VALUES('" & Data10.Recordset.Fields(0) & "','" & Data10.Recordset.Fields(20) & "','" & Data10.Recordset.Fields(1) & "','" & Data10.Recordset.Fields(2) & "','" & Data10.Recordset.Fields(2 * k + 6 - 1) & "','" & Data10.Recordset.Fields(2 * k + 6) & "')"
End If
Next
Data10.Recordset.MoveNext
Loop
...
Data6.Database.Execute "update sczy_xdd set 进度='进行' where 单号='" & DH & "'"
Else
Data6.Database.Execute "update sczy_xdd set 进度='结束' where 单号='" & DH & "'"
End If

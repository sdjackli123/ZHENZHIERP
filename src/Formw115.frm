...
Begin VB.Form Formw115 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "Formw115.frx":0015
      Left            =   5760
      List            =   "Formw115.frx":0022
      TabIndex        =   16
      Text            =   "Combo1"
      Top             =   1440
      Width           =   975
...
Call MXOutadodcToExcel(VSFlexGrid1, "利润表设置")
End Sub
...
Adodc1.RecordSource = "select * from LRB order by 序号 DESC"
Adodc1.Refresh
For i = 0 To 4
Text1(i).Text = ""
Next

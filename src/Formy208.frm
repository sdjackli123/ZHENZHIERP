...
If Option1.Value = True Then
    Data12.RecordSource = "select distinct 客户 from sczy_xtd where 日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='进行'"
    Data12.Refresh
    m = 1
    If Not Data12.Recordset.EOF Then  'make sure there are records in the table
        ...
        Data13.RecordSource = "select distinct 单号 from sczy_xtd where 客户='" & Data12.Recordset.Fields(0) & "' and  日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='进行'"
        Data13.Refresh
        ...
        Data14.RecordSource = "select distinct 款号 from sczy_xtd where 单号='" & Data13.Recordset.Fields(0) & "' and 进度='进行'"
        Data14.Refresh
...
If Option3.Value = True Then
    Data12.RecordSource = "select distinct 客户 from sczy_xtd where 日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "')"
    Data12.Refresh
    m = 1
    If Not Data12.Recordset.EOF Then  'make sure there are records in the table
        Data12.Recordset.MoveFirst
        ...
        mNode.Text = Data12.Recordset.Fields(0)
        intIndex = mNode.Index
        Data13.RecordSource = "select distinct 单号 from sczy_xtd where 客户='" & Data12.Recordset.Fields(0) & "' and  日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "')"
        Data13.Refresh
        ...
        mNode.Text = Trim(Data13.Recordset.Fields(0))
        xntIndex = mNode.Index
        Data14.RecordSource = "select distinct 款号 from sczy_xtd where 单号='" & Data13.Recordset.Fields(0) & "'"
        Data14.Refresh
...
If Option2.Value = True Then
    Data12.RecordSource = "select distinct 客户 from sczy_xtd where 日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='结束'"
    Data12.Refresh
    m = 1
    If Not Data12.Recordset.EOF Then  'make sure there are records in the table
        Data12.Recordset.MoveFirst
        ...
        mNode.Text = Data12.Recordset.Fields(0)
        intIndex = mNode.Index
        Data13.RecordSource = "select distinct 单号 from sczy_xtd where 客户='" & Data12.Recordset.Fields(0) & "' and  日期 between cdate('" & DTPicker1.Value & "') and cdate('" & DTPicker2.Value & "') and 进度='结束'"
        Data13.Refresh
        ...
        mNode.Text = Trim(Data13.Recordset.Fields(0))
        xntIndex = mNode.Index
        Data14.RecordSource = "select distinct 款号 from sczy_xtd where 单号='" & Data13.Recordset.Fields(0) & "' and 进度='结束'"
        Data14.Refresh
...
If yhmk = "销售" Then
Formy207.DBCombo1.Text = Data2.Recordset.Fields(27)
Formy207.DBCombo2.Text = Data2.Recordset.Fields(0)
Formy207.Show
End If
End Sub
...
Data2.RecordSource = "select * from sczy_xtd where 客户='" & TreeView1.Nodes(Node.Index).FullPath & "'"
Data2.Refresh
Else
...
l1 = Mid(TreeView1.Nodes(Node.Index).FullPath, InStr(TreeView1.Nodes(Node.Index).FullPath, "\") + 1)
End If
Data2.RecordSource = "select * from sczy_xtd where 单号='" & l1 & "'"
Data2.Refresh
End If

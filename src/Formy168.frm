...
Set g_Cmd = New Command
    ...
    g_Cmd.CommandText = "CLPCCZCXF('" & DTPicker3.value & "','" & DTPicker4.value & "','" & yhxx & "')"      ' 表示调用哪个存储过程
...
Call MXOutadodcToExcel(VSFlexGrid1, "分库材料库存")
End Sub

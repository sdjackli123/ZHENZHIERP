...
Begin VB.Form Formw116 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "Formw116.frx":0000
      Left            =   6000
      List            =   "Formw116.frx":000D
      TabIndex        =   16
      Text            =   "Combo1"
      Top             =   960
      Width           =   975
...
Call MXOutadodcToExcel(VSFlexGrid1, "现金流量表设置")
End Sub
...
Adodc1.RecordSource = "select * from XJB order by 序号 DESC"
Adodc1.Refresh
For i = 0 To 4
Text1(i).Text = ""
Next

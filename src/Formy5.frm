...
Set rd = ba.OpenRecordset("KHZL", dbOpenDynaset)
Data1.DatabaseName = "d:\数据库\\htgl\2011\SCZYJHD.mdb"
Data1.RecordSource = "select * from KHZL order by val(ip)"
Data1.Refresh
If Data1.Recordset.EOF Then
MSFlexGrid1.TextMatrix(0, 0) = "记录号"
Else

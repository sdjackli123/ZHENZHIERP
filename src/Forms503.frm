...
Begin VB.Form Forms503 
   ...
   Begin VB.ComboBox Combo2 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "Forms503.frx":0000
      Left            =   840
      List            =   "Forms503.frx":001C
      TabIndex        =   57
      Text            =   "Combo1"
      Top             =   3600
      Width           =   2535
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   435
      ItemData        =   "Forms503.frx":0055
      Left            =   840
      List            =   "Forms503.frx":0062
      TabIndex        =   3
      Text            =   "Combo1"
      Top             =   1200
      Width           =   2535
...
Adodc1.RecordSource = "select * FROM DDCL where 时间=cast('" & DTPicker1.value & "' as datetime) AND 班次='" & Combo1.Text & "' ORDER BY 其它系数 DESC"
Adodc1.Refresh
End Sub
...
'    g_Cmd.CommandText = "KFCCJC"      ' 表示调用哪个存储过程
...
'If (Val(g_Cmd.Parameters("cl").Value) + Val(Text1(10).Text)) > Val(g_Cmd.Parameters("pb").Value) Then
    If Text1(16) <> "" Then
    sql2 = "insert into gpmdbz(单号,锅号,序号,备注) VALUES('" & Forms51.DataCombo4(15) & "','" & Forms51.DataCombo4(1) & "','" & Forms51.DataCombo4(16) & "','" & Text1(16) & "')"
...
'    g_Cmd.ActiveConnection = g_Con          ' 连接到数据库
'    g_Cmd.CommandType = adCmdStoredProc     ' 表示cmd的类型为存储过程
'    g_Cmd.CommandText = "cjkftj('" & Text1(0).Text & "','" & Text1(1).Text & "','" & Text1(2).Text & "','" & Text1(3).Text & "','" & Text1(4).Text & "','" & Text1(5).Text & "','" & Text1(6).Text & "','" & Text1(7).Text & "','" & Text1(8).Text & "','" & Text1(9).Text & "','" & Text1(10).Text & "','" & Text1(11).Text & "','" & Text1(12).Text & "','" & Text1(13).Text & "','" & Text1(14).Text & "','" & Text1(15).Text & "','" & Text1(16).Text & "','" & Text1(17).Text & "','" & Text1(18).Text & "')"     ' 表示调用哪个存储过程
'    g_Cmd.Execute           ' 执行存储过程
'    g_Cmd.Cancel
'MsgBox ("超出产量")
'Else
...
Text1(0).Text = ""
Adodc3.RecordSource = "select max(其它系数) FROM DDCL where 时间=cast('" & DTPicker1.value & "' as datetime)"
Adodc3.Refresh
Text1(14).Text = "1"
...
Call BBDY(VSFlexGrid1, 12, 17, "大定型产量")
End Sub
...
Command1.Enabled = True
    ...
    sql2 = "delete from gpmdbz where 单号='" & Forms51.DataCombo4(15) & "' and 序号='" & Forms51.DataCombo4(16) & "' and 锅号='" & Forms51.DataCombo4(1) & "'"
    RD.Open sql2, conn, adOpenStatic, adLockOptimistic
...
On Error Resume Next
Adodc1.RecordSource = "select * FROM DDCL where 时间=cast('" & DTPicker1.value & "' as datetime) ORDER BY 其它系数 DESC"
Adodc1.Refresh
Adodc3.RecordSource = "select max(其它系数) FROM DDCL where 时间=cast('" & DTPicker1.value & "' as datetime)"
Adodc3.Refresh
Text1(14).Text = "1"
...
Adodc1.RecordSource = "select * FROM DDCL where cast(CONVERT(varchar,时间, 23) as datetime) between cast('" & DTPicker2.value & "' as datetime) and cast('" & DTPicker3.value & "' as datetime) order by 时间"
Adodc1.Refresh
Else
Adodc1.RecordSource = "select * FROM DDCL where 锅号='" & Text1(2).Text & "' order by 时间"
Adodc1.Refresh
End If
End Sub
...
Adodc1.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc1.RecordSource = "select * FROM DDCL where 时间=cast('" & DTPicker1.value & "' as datetime)"
Adodc1.Refresh
End Sub
...
Adodc5.RecordSource = "SELECT 工序其它系数 FROM gyshd WHERE 工艺编号 between  '9001' and '9999' GROUP BY 工序其它系数"
Adodc5.Refresh
...
Text1(10).Text = ""
Else
Adodc11.RecordSource = "select isnull(sum(重量),1),isnull(sum(匹数),0) from kpd where 锅号='" & Text1(2).Text & "' and 卡号 like '%'+'" & Combo2 & "'+'%'"
Adodc11.Refresh
...
End If
If cldj = 1 Then
If InStr(Text1(7), "成品") > 0 Then
Text1(5) = Forms51.Adodc7.Recordset.Fields(0)
Text1(10) = Forms51.Adodc7.Recordset.Fields(1)
Else
Text1(5) = Forms51.DataCombo4(6)
Text1(10) = Forms51.DataCombo4(7)
End If
End If
End Sub
...
Adodc6.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc6.RecordSource = "select 单号,客户名称,品名,色别+色名 as 色别,重量 from kpd where 锅号='" & Text1(2).Text & "'"
Adodc6.Refresh
If Adodc6.Recordset.EOF Then
...
Call Label3_Click
Adodc6.RecordSource = "select 工艺 from ghgy where 锅号='" & Text1(2).Text & "'"
Adodc6.Refresh
If Not Adodc6.Recordset.EOF Then
Text1(11) = Adodc6.Recordset.Fields(0)
End If
Text1(7).SetFocus
End If
...
Text1(15).Text = Format(Val(Text1(5).Text) * Val(Text1(13).Text), "#0.00")
End If

Case 10
If Option1.value = True Then
Text1(15).Text = Format(Val(Text1(10).Text) * Val(Text1(13).Text), "#0.00")
End If

...
Adodc2.RecordSource = "select * from WDZSZ where  日期 between '" & Text1 & "' and '" & Text2 & "'  ORDER BY 日期 DESC"
Adodc2.Refresh
Text3.Text = ""
Text4.Text = ""
End Sub
...
Adodc2.RecordSource = "select * from WDZSZ where 客户='" & DataCombo1.Text & "' and 日期 between '" & Text1 & "' and '" & Text2 & "' ORDER BY 日期 DESC"
Adodc2.Refresh
End Sub

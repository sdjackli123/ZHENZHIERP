...
Private Sub Command1_Click()
    ...
    g_Cmd.CommandText = "rsclbbsc('" & Text1.Text & "','" & Text2.Text & "')"      ' 表示调用哪个存储过程
    g_Cmd.Execute           ' 执行存储过程
    g_Cmd.Cancel
Adodc2.RecordSource = "SELECT * FROM RSCLBB ORDER BY 日期"
Adodc2.Refresh
End Sub

Private Sub Command2_Click()
Call fhbb(VSFlexGrid1, 2, 3, 4, 5, 6, 7, "染色报表" + Text1.Text + "-" + Text2.Text)
End Sub

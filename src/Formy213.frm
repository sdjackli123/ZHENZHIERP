...
Begin VB.Form Formy123 
   ...
   End
End
Attribute VB_Name = "Formy123"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command1_Click()
Adodc1.RecordSource = "select 客户,单号,款号,品名,计划 from sczy_x where 单号 like '%'+'" & Text1.Text & "'+'%' order by 序号"
Adodc1.Refresh
End Sub
...
Adodc1.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=fydn"
Adodc1.RecordSource = "select 客户,单号,款号,品名,计划 from sczy_x where 款号 like '%'+'" & Text2.Text & "'+'%' order by 序号"
Adodc1.Refresh
End Sub

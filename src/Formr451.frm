...
End If
Text1(2) = Val(Text1(2))
sql1 = "INSERT INTO  pldr(料单编号,工序名称,染化助库,染化助名称,配料单位,配料用量,配料日期,次序号,机台,实际称量) VALUES('" & Text1(0) & "','补料','助剂','" & Text1(1) & "','kg','" & Text1(2) & "','" & Now & "','" & cxh & "','补料',0)"
...
Adodc1.RecordSource = "select 液体名称,液体编号 from YTSB order by 液体编号"
Adodc1.Refresh

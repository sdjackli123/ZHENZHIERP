...
Adodc2.RecordSource = "select distinct 染料名称 from rhzh where 简码 like '%'+'" & Text2.Text & "'+'%'  order by 染料名称"
Adodc2.Refresh
End Sub
...
Adodc1.RecordSource = "SELECT * from yj_rlyj order by 序号 desc"
Adodc1.Refresh
For i = 0 To 3
Text1(i).Text = ""
Next

...
Begin VB.Form Formr449 
   ...
   Begin VSFlex8UCtl.VSFlexGrid VSFlexGrid1 
      ...
      FormatString    =   $"Formr449.frx":0015
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Text1(i).Text = ""
Next
Text1(7) = Adodc1.Recordset.RecordCount + 1
DataCombo1.Text = ""
DataCombo1.SetFocus
...
Call MXOutadodcToExcel(VSFlexGrid1, "定型料缸输送信息表")
End Sub
...
Adodc1.RecordSource = "select * from ctdx order by 序号"
Adodc1.Refresh

...
If Combo1.Text = "总类账户" Then
Adodc1.RecordSource = "SELECT * FROM PMZJZ WHERE 日期='" & Text1(0).Text & "' ORDER BY 序号  DESC"
Adodc1.Refresh
End If

If Combo1.Text = "明细账户" Then
If Text1(3).Text = "" Then
Adodc1.RecordSource = "SELECT * FROM PMMXJZ WHERE 日期='" & Text1(0).Text & "'  ORDER BY 序号  DESC"
Adodc1.Refresh
Else
Adodc1.RecordSource = "SELECT * FROM PMMXJZ WHERE 日期='" & Text1(0).Text & "'  ORDER BY 序号  DESC"
Adodc1.Refresh
...
If Combo1.Text = "特种账户" Then
Adodc1.RecordSource = "SELECT * FROM PMTZ WHERE 日期='" & Text1(0).Text & "' ORDER BY 序号  DESC"
Adodc1.Refresh
End If
Text1(1).Text = "结-" + Trim(Month(Text1(0).Text) - 1)
Text1(2).Text = "期初余额"
...
If Combo1.Text = "总类账户" Then
Adodc1.RecordSource = "SELECT * FROM PMZJZ WHERE 日期='" & Text1(0).Text & "' AND 会计科目 like '%'+'" & Text1(3).Text & "'+'%' ORDER BY 序号  DESC"
Adodc1.Refresh
End If

If Combo1.Text = "明细账户" Then
Adodc1.RecordSource = "SELECT * FROM PMMXJZ WHERE 日期='" & Text1(0).Text & "' AND 会计科目 like '%'+'" & Text1(3).Text & "'+'%' ORDER BY 序号  DESC"
Adodc1.Refresh
End If

If Combo1.Text = "特种账户" Then
Adodc1.RecordSource = "SELECT * FROM PMTZ WHERE 日期='" & Text1(0).Text & "' AND 会计科目 like '%'+'" & Text1(3).Text & "'+'%' ORDER BY 序号  DESC"
Adodc1.Refresh
End If
Text1(9).Text = Adodc1.Recordset.RecordCount + 1
...
Select Case Index
       Case 3
If Combo1.Text = "明细账户" Then
Adodc1.RecordSource = "SELECT * FROM PMMXJZ WHERE 会计科目 like '%'+'" & Text1(3).Text & "'+'%' AND 日期='" & Text1(0).Text & "' ORDER BY 序号  DESC"
Adodc1.Refresh
End If
End Select
End Sub

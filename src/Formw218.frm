...
Adodc3.RecordSource = "SELECT 供应单位,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,是否含税,是否开票,是否付款,单据号,日期 FROM CKGL WHERE 日期 BETWEEN CDATE('" & Text1.Text & "') AND CDATE('" & Text2.Text & "') AND 库别='采购入库' ORDER BY 单据号"
Adodc3.Refresh
Else
Adodc3.RecordSource = "SELECT 供应单位,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,是否含税,是否开票,是否付款,单据号,日期 FROM CKGL WHERE 供应单位='" & DataCombo1.Text & "' AND 日期 BETWEEN CDATE('" & Text1.Text & "') AND CDATE('" & Text2.Text & "')  AND 库别='采购入库' ORDER BY 单据号"
Adodc3.Refresh
End If
End Sub
...
Adodc2.Database.Execute "update ckgl set 合计金额=format(数量*单价,'#0.00') where 日期 BETWEEN CDATE('" & Text1.Text & "') AND CDATE('" & Text2.Text & "')"
Call Command3_Click
End Sub
...
Adodc3.RecordSource = "SELECT 供应单位,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,是否含税,是否开票,是否付款,单据号,日期 FROM CKGL WHERE 日期 BETWEEN CDATE('" & Text1.Text & "') AND CDATE('" & Text2.Text & "')"
Adodc3.Refresh

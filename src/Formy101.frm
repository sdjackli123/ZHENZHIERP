...
sql1 = "DELETE  FROM CLGL WHERE  库别='清库库存'"
sql2 = "INSERT INTO CLGL(单号,合约号,供应单位,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,库类,日期,库别,单据号,序号) SELECT '','',供应单位,材料名称,材料规格,材料单位,颜色,批次,数量,单价,金额,库类,日期,'清库库存','00000000','1' FROM CLJL1 WHERE 日期=cast('" & DataCombo1(7).Text & "' as datetime)"
...
Set g_Cmd = New Command
    ...
    g_Cmd.CommandText = "fclckkc('" & RQ & "')"    ' 表示调用哪个存储过程
...
Adodc1.RecordSource = "SELECT * FROM CLJL1 WHERE 材料名称='" & DataCombo1(1).Text & "' AND 日期=cast('" & DataCombo1(7).Text & "' as datetime)"
Adodc1.Refresh
End Sub
...
Select Case Index
       ...
       Adodc1.RecordSource = "SELECT * FROM CLJL1 WHERE 库类='" & DataCombo1(10).Text & "' and 日期=cast('" & DataCombo1(7).Text & "' as datetime)"
       Adodc1.Refresh
End Select
End Sub
...
Select Case Index
       Case 7
       Adodc1.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
       Adodc1.RecordSource = "SELECT * FROM CLJL1 WHERE 日期=cast('" & DataCombo1(7).Text & "' as datetime)"
       Adodc1.Refresh
       Case 10
       Adodc1.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
       Adodc1.RecordSource = "SELECT * FROM CLJL1 WHERE 库类='" & DataCombo1(10).Text & "' and 日期=cast('" & DataCombo1(7).Text & "' as datetime)"

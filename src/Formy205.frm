...
If yhmk = "计划" Then
Formy20.DBCombo1.Text = Data2.Recordset.Fields(27)
Formy20.DBCombo2.Text = Data2.Recordset.Fields(0)
Formy20.Show
End If
End Sub
...
Data2.RecordSource = "select * from sczy_xdh where 客户='" & TreeView1.Nodes(Node.Index).FullPath & "'"
Data2.Refresh
Else
...
l1 = Mid(TreeView1.Nodes(Node.Index).FullPath, InStr(TreeView1.Nodes(Node.Index).FullPath, "\") + 1)
End If
Data2.RecordSource = "select * from sczy_xdh where 单号='" & l1 & "'"
Data2.Refresh
End If

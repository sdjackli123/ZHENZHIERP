...
Adodc2.RecordSource = "select * from CLCKKC3 WHERE 库类='" & DataCombo3.Text & "' and 材料名称 like '%'+'" & DataCombo1.Text & "'+'%' and 库存量>0"
Adodc2.Refresh
End Sub
...
Adodc7.RecordSource = "SELECT MAX(序号) FROM CLKPD WHERE 单据号='" & DataCombo4(14).Text & "' "
Adodc7.Refresh
Adodc8.Refresh
...
Adodc8.RecordSource = "SELECT * FROM clckdj"
Adodc8.Refresh
...
Adodc6.RecordSource = "SELECT * FROM CLKPD WHERE 单据号='" & DataCombo4(14).Text & "' ORDER BY 序号 desc"
Adodc6.Refresh
...
Adodc2.RecordSource = "select * from CLCKKC3 WHERE  库类='" & DataCombo3.Text & "' and 库存量>0 ORDER BY 库类,材料名称,材料规格,材料单位,颜色,批次"
Adodc2.Refresh
End Sub
...
Adodc5.RecordSource = "SELECT 材料名称 FROM CLCKKC3 WHERE 库存量>0 AND 库类='" & DataCombo3.Text & "' GROUP BY 材料名称"
Adodc5.Refresh
End Sub
...
Adodc2.RecordSource = "select * from CLCKKC3 WHERE 库存量>0 order BY 库类,材料名称,材料规格,材料单位,颜色,批次"
Adodc2.Refresh
...
Adodc9.RecordSource = "select 名称 from CLCJ  GROUP BY 名称"
Adodc9.Refresh
Adodc15.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
...
For i = 3 To 9
DataCombo4(i).Text = Adodc2.Recordset.Fields(i - 1)
Next
DataCombo4(9).Text = 0
DataCombo4(16).Text = Adodc2.Recordset.Fields(1)

...
Call MXOutadodcToExcel(VSFlexGrid1, "订单预警")
End Sub

Private Sub Command6_Click()
Text1(4).Text = Adodc1.Recordset.RecordCount + 1
...
Adodc1.RecordSource = "SELECT * from yj_ddyj  order by 序号 desc"
Adodc1.Refresh
For i = 0 To 4
Text1(i).Text = ""
Next

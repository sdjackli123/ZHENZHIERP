...
Begin VB.Form Forms498 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   435
      ItemData        =   "Forms498.frx":0000
      Left            =   3240
      List            =   "Forms498.frx":000D
      TabIndex        =   1
      Text            =   "Combo1"
      Top             =   360
      Width           =   3375
...
Adodc1.RecordSource = "select * FROM rsbb where cast(CONVERT(varchar,日期, 23) as datetime) between cast('" & DTPicker2.value & "' as datetime) and cast('" & DTPicker3.value & "' as datetime) and 班次 like '%'+'" & Combo1.Text & "'+'%' order by 日期"
Adodc1.Refresh
Adodc7.RecordSource = "select round(sum(匹数),1) as 合计匹数,round(sum(重量),2) as 合计重量 FROM rsbb where cast(CONVERT(varchar,日期, 23) as datetime) between cast('" & DTPicker2.value & "' as datetime) and cast('" & DTPicker3.value & "' as datetime) and 班次 like '%'+'" & Combo1.Text & "'+'%'"
Adodc7.Refresh
End Sub
...
Adodc1.RecordSource = "select * FROM rsbb where 日期=cast('" & DTPicker2.value & "' as datetime) AND 班次='" & Combo1.Text & "' order BY 序号 DESC"
Adodc1.Refresh

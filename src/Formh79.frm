...
sql1 = "update sczy_x set 状态='生产'  where 单号='" & Text1 & "' and 序号='" & List1.List(i) & "'"
...
Adodc1111.RecordSource = "SELECT 序号 from sczy_x where 单号='" & Text1.Text & "' and 状态='作废' order by 序号"
Adodc1111.Refresh

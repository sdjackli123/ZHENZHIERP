...
End If
Next
       Adodc7.RecordSource = "SELECT * FROM SSGY WHERE  模板编号='" & DataCombo1(1).Text & "' ORDER BY 工艺名称,序号"
       Adodc7.Refresh
                '''''''''''''''''''''''
For i = 0 To 6
DataCombo2(i).Text = ""
...
Select Case Index
       ...
       Adodc4.RecordSource = "select 模板编号 from SSGY where 工艺名称='" & DataCombo1(0).Text & "'group by 模板编号 ORDER BY 模板编号"
       Adodc4.Refresh
...
Adodc4.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc4.RecordSource = "select 模板编号 from SSGY group by 模板编号 ORDER BY 模板编号"
Adodc4.Refresh
...
Select Case Index
       Case Index
Adodc8.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc8.RecordSource = "SELECT 染料名称 FROM v_rhzh where 简码 like '%'+'" & Text5(Index) & "'+'%' and 染化助库名='" & DataCombo1(2) & "'"
Adodc8.Refresh

...
Set BA = OpenDatabase("d:\数据库\bfrz\" + ljb + "\CJBB.MDB")
Set RD = BA.OpenRecordset("rqsd", dbOpenDynaset)
...
Private Sub Formw_Unload(Cancel As Integer)

...
Set rd = ba.OpenRecordset("CLDW", dbOpenDynaset)
Data1.DatabaseName = "d:\数据库\\htgl\2011\CKGL.MDB"
Data1.RecordSource = "SELECT CLDW.MC as 材料单位,IP from CLDW"
Data1.Refresh
Text1.Text = ""
Text2.Text = Data1.Recordset.RecordCount + 1

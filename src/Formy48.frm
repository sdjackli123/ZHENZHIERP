...
Adodc1.RecordSource = "SELECT 库类,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,单据号,日期,领料车间 FROM CLKPD1 WHERE (" + sql1 + ") order by 日期"
Adodc1.Refresh
End Sub
...
Adodc1.RecordSource = "SELECT 库类,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,单据号,日期,领料车间 FROM CLKPD1 WHERE 日期 BETWEEN cast('" & DTPicker1.value & "' as datetime) AND cast('" & DTPicker2.value & "' as datetime) order by 日期"
Adodc1.Refresh

...
Adodc2.RecordSource = "SELECT 供应单位,材料名称,数量,材料单位,库类 FROM KCCXHZ WHERE KCCXHZ.数量<>0 AND KCCXHZ.材料名称='" & DataCombo1.Text & "'"
Adodc2.Refresh
End Sub
...
Adodc2.RecordSource = "SELECT 供应单位,材料名称,数量,材料单位,库类 FROM KCCXHZ WHERE KCCXHZ.数量<>0 AND KCCXHZ.库类='" & DataCombo3.Text & "'"
Adodc2.Refresh
End Sub
...
Adodc3.RecordSource = "SELECT * from KCCXHZ"
Adodc3.Refresh

Adodc1.RecordSource = "select * from RHZH"
Adodc1.Refresh
If Not Adodc3.Recordset.EOF Then
Adodc3.Recordset.MoveFirst
Do While Not Adodc3.Recordset.EOF
Adodc3.Recordset.Edit
Adodc1.Recordset.FindFirst "染料名称='" & Adodc3.Recordset.Fields(1) & "'"
If Adodc1.Recordset.NoMatch Then
Adodc3.Recordset.Fields(0) = ""
Else
Adodc3.Recordset.Fields(0) = Adodc1.Recordset.Fields(1)
End If
...
Adodc2.RecordSource = "SELECT 供应单位,材料名称,数量,材料单位,库类 FROM KCCXHZ WHERE KCCXHZ.数量<>0 ORDER BY KCCXHZ.库类"
Adodc2.Refresh
...
Adodc8.DatabaseName = "d:\数据库\bfrz\" + ljb + "\hys.mdb"

...
Begin VB.Form Formy501 
   ...
   End
End
Attribute VB_Name = "Formy501"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command1_Click()
Data2.RecordSource = "SELECT 单号,款号,颜色,材料名称,纱支,配比,采购量,期限 FROM sxcg WHERE 单号='" & DBCombo1.Text & "' and  instr(款号,'" & DBCombo2.Text & "')>0 order by 款号,颜色,材料名称,纱支"
Data2.Refresh
Data4.RecordSource = "select * from sxrk where 单号='" & DBCombo1.Text & "' and instr(款号,'" & DBCombo2.Text & "')>0 order by 材料,纱支"
Data4.Refresh
End Sub

Private Sub Command2_Click()
Data2.RecordSource = "SELECT 单号,款号,颜色,材料名称,纱支,配比,采购量,期限 FROM sxcg WHERE 单号='" & DBCombo1.Text & "' order BY 单号,款号,颜色,材料名称,纱支"
Data2.Refresh
Data1.RecordSource = "SELECT 款号 FROM sxcg WHERE 单号='" & DBCombo1.Text & "' group BY 款号"
Data1.Refresh
End Sub
...
Data5.RecordSource = "select 简称 from SXZL group by 简称"
Data5.Refresh
Data6.DatabaseName = "d:\数据库\\htgl\2011\SCZYJHD.mdb"
Data6.RecordSource = "select 简称 from ZBZL group by 简称"
Data6.Refresh
Command7.Enabled = True
Command8.Enabled = False
Command6.Enabled = False
...
Text1(8).Text = DBCombo4.Text
End Sub

Private Sub DBCombo5_Click(Area As Integer)
Text1(9).Text = DBCombo5.Text
End Sub

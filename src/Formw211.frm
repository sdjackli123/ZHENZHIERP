...
sql1 = sql1 + "库别 like '%'+'" & DataCombo3 & "'+'%' and "
End If
...
sql1 = sql1 + "供应单位 like '%'+'" & DataCombo1 & "'+'%' and "
End If

If Check2(5).value = 1 Then
sql1 = sql1 + "库类 like '%'+'" & DataCombo2 & "'+'%' and "
End If
...
Adodc3.RecordSource = "SELECT 供应单位,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,包件,是否开票,是否付款,单据号,日期 FROM CLGL WHERE (" + sql1 + ")  AND 库别='采购入库' ORDER BY 日期,单据号"
Adodc3.Refresh
...
Adodc1.RecordSource = "select 简称 from GYS where ip like '%'+'" & yhxx & "'+'%' GROUP BY 简称"
Adodc1.Refresh
...
Adodc3.RecordSource = "SELECT 供应单位,材料名称,材料规格,材料单位,颜色,批次,数量,单价,合计金额,包件,是否开票,是否付款,单据号,日期 FROM CLGL WHERE 日期 BETWEEN '" & DTPicker3.value & "' AND '" & DTPicker4.value & "' order by 日期,单据号"
Adodc3.Refresh
...
Adodc1.ConnectionString = "Provider=SQLOLEDB.1;Password=fjrj;Persist Security Info=True;User ID=sa;Initial Catalog=zzpr;Data Source=192.168.1.254"
Adodc1.RecordSource = "select 简称 from GYS where ip like '%'+'" & yhxx & "'+'%' and 代码 like '%'+'" & Text1 & "'+'%' GROUP BY 简称"
Adodc1.Refresh
End Sub
